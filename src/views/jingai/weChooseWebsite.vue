<template>
  <div>
    ...
    >
      ...
      <el-table-column show-overflow-tooltip prop="welllidDevice.fAlias" label="设备名称" sortable />
      ...
      <el-table-column show-overflow-tooltip prop="welllidDevice.fDeviceStatusUpdateTime" label="更新时间" />
      <el-table-column show-overflow-tooltip prop="welllidDevice.longitude" label="经度" />
      <el-table-column show-overflow-tooltip prop="welllidDevice.latitude" label="纬度" />
      <el-table-column show-overflow-tooltip prop="welllidDevice.fDeviceType" label="设备类型" />
      <el-table-column show-overflow-tooltip prop="welllidDevice.address" label="地址" />
    </el-table>
    <el-pagination
