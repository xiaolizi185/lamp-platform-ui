  ...
  <div class="app-container">
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column show-overflow-tooltip min-width="100" prop="stationAlert.parentid" width="180" label="设备编号" sortable />
        <el-table-column show-overflow-tooltip min-width="100" prop="stationAlert.alarmContent" label="内容值" />
        <el-table-column show-overflow-tooltip min-width="100" prop="stationAlert.createtime" width="180" label="报警时间" sortable />
