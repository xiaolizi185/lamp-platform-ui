<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column show-overflow-tooltip prop="fDevId" label="设备标识" sortable />
      <el-table-column show-overflow-tooltip prop="fState" label="状态" />
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      this.$axios.get('/acloud-lighting/ViewOneKeyToLamp/getViewOneKeyToLamp?page=' + this.tableData.params.currentPage + '&size=' + this.tableData.params.pageSize).then(res => {
