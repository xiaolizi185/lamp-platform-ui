    ...
    <el-form ref="form" :rules="model.rules" :model="model" label-width="100px">
      <el-form-item label="灯杆图标" prop="fImg" class="form-item" :rules="model.rules.fImg">
        <el-upload
          ...
          :file-list="file_list"
        >
          <img v-if="model.fImg" :src="model.fImg" class="avatar" style="height: 180px">
    ...
    saveType() {
      ...
      this.$refs.form.validate(v => {
        ...
        .then((res) => {
          ...
          this.$axios.post('/acloud-file/file/upload?fImg='+entityobj.fileId+'&fName=' + this.model.fName + '&fRemark=' + this.model.fRemark + '&fCreateId=' + Vue.getAcloudProvider().getUserInfo().id, this.formData, {
            ...
            if (res.data.code === 20000) {
              ...
              this.loaddata()
              this.drawer.addTypeDrawer.hide()
              return
            } else {
