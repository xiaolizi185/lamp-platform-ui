<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;margin-top: 10px;cursor: pointer;overflow: auto"
  ...
  methods: {
    ...
    confirmSave() {
      ...
      if (this.tableChecked.length === 0) {
        ...
        this.$axios.post('/acloud-lighting/lampPole/restore?autoId=' + delParams).then(res => {
          if (res.data.code === 20000) {
            this.$message.success('恢复成功。')
            this.loaddata()
            this.drawer2.resumeInfoDrawer1.hide()
          } else {
