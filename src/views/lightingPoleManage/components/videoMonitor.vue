<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column show-overflow-tooltip prop="fSerial" label="序列号" sortable />
      <el-table-column show-overflow-tooltip prop="address" label="地址" />
      <el-table-column show-overflow-tooltip  label="分配" width="70">
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      this.$axios.post('/acloud-lighting/ViewVideoToLamp/getViewVideoToLamp?page=' + this.tableData.params.currentPage + '&size=' + this.tableData.params.pageSize,params).then(res => {
